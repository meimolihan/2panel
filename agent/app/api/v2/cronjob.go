...
func (b *BaseApi) CreateCronjob(c *gin.Context) {
	...
	if err := cronjobService.Create(req, "system"); err != nil {
...
func (b *BaseApi) ImportCronjob(c *gin.Context) {
	...
	if err := cronjobService.Import(req.Cronjobs, "system"); err != nil {
		helper.InternalServer(c, err)
		return
	}
	helper.Success(c)
...
func (b *BaseApi) UpdateCronjob(c *gin.Context) {
	...
	if err := cronjobService.Update(req.ID, req, "system"); err != nil {
		helper.InternalServer(c, err)
		return
	}
	helper.Success(c)
