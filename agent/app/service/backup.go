...
import (
	...
	"github.com/2Panel-dev/2Panel/agent/utils/cloud_storage"
	"github.com/2Panel-dev/2Panel/agent/utils/cloud_storage/client"
...
func (u *BackupService) checkBackupConn(backup *model.BackupAccount) (bool, error) {
	...
	fileItem := path.Join(global.Dir.BaseDir, "2panel/tmp/test/1panel")
