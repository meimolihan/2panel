...
import (
	...
	"github.com/2Panel-dev/2Panel/agent/utils/compose"
...
func getComposeCmd(composePath, subCommand string) *exec.Cmd {
	return exec.Command("docker-compose", "-f", composePath, subCommand)
}
