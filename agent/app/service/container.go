...
func removeUnsupportedEndpointStaticIPAM(client *client.Client, networkConf *network.NetworkingConfig, extraNetworks map[string]*network.EndpointSettings) {
}

func buildContainerRecoverNetworkConfig(networkSettings *container.NetworkSettings, hostConf *container.HostConfig) (*network.NetworkingConfig, map[string]*network.EndpointSettings) {
	return nil, nil
}
