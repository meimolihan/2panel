...
import (
	...
	"github.com/2Panel-dev/2Panel/agent/cron"
	"github.com/2Panel-dev/2Panel/agent/global"
	"github.com/2Panel-dev/2Panel/agent/i18n"
	"github.com/2Panel-dev/2Panel/agent/init/cache"
	"github.com/2Panel-dev/2Panel/agent/init/db"
	"github.com/2Panel-dev/2Panel/agent/init/dir"
	"github.com/2Panel-dev/2Panel/agent/init/firewall"
	"github.com/2Panel-dev/2Panel/agent/init/hook"
	"github.com/2Panel-dev/2Panel/agent/init/lang"
	"github.com/2Panel-dev/2Panel/agent/init/log"
	"github.com/2Panel-dev/2Panel/agent/init/migration"
	"github.com/2Panel-dev/2Panel/agent/init/router"
	"github.com/2Panel-dev/2Panel/agent/init/validator"
	"github.com/2Panel-dev/2Panel/agent/init/viper"
	"github.com/2Panel-dev/2Panel/agent/utils/encrypt"
	"github.com/2Panel-dev/2Panel/agent/utils/re"
)

const (
	masterSocketDir          = "/etc/2panel"
