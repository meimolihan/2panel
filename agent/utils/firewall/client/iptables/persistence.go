...
const (
	BasicBeforeFileName = "2panel_basic_before.rules"
	BasicFileName       = "2panel_basic.rules"
	BasicAfterFileName  = "2panel_basic_after.rules"
	InputFileName       = "2panel_input.rules"
	OutputFileName      = "2panel_out.rules"
	ForwardFileName     = "2panel_forward.rules"
	ForwardFileName1    = "2panel_forward_pre.rules"
	ForwardFileName2    = "2panel_forward_post.rules"
)
