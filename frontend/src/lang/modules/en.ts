...
const message = {
    ...
    setting: {
        ...
        fullBackup: 'Full Backup | Full Backups',
        restoreFullBackupConfirm: 'Are you sure you want to restore from this full backup? This will overwrite the current data.',
