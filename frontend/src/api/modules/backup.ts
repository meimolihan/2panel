...
export const createFullBackup = (params: Record<string, any>) => {
	return http.post(`/backups/fullbackup`, params);
};
export const searchFullBackup = (params: Record<string, any>) => {
	return http.post(`/backups/fullbackup/search`, params);
};
export const deleteFullBackup = (params: { ids: number[]; deleteWithFile: boolean }) => {
	return http.post(`/backups/fullbackup/del`, params);
};
export const updateFullBackupDescription = (id: number, description: string) => {
	return http.post(`/backups/fullbackup/description/update`, { id, description });
};
export const restoreFullBackup = (params: Record<string, any>) => {
	return http.post(`/backups/fullrecover`, params);
};
