...
import (
	...
	appauth "github.com/2Panel-dev/2Panel/core/app/auth"
	"github.com/2Panel-dev/2Panel/core/app/service"
	"github.com/2Panel-dev/2Panel/core/cmd/server/docs"
	"github.com/2Panel-dev/2Panel/core/cmd/server/web"
	"github.com/2Panel-dev/2Panel/core/global"
	"github.com/2Panel-dev/2Panel/core/i18n"
	"github.com/2Panel-dev/2Panel/core/init/swagger"
	"github.com/2Panel-dev/2Panel/core/middleware"
	rou "github.com/2Panel-dev/2Panel/core/router"
	"github.com/2Panel-dev/2Panel/core/utils/security"
...
func Routers() *gin.Engine {
	...
	swaggerRouter := Router.Group("2panel")
...
func RegisterImages(rootRouter *gin.RouterGroup) {
	staticDir := filepath.Join(global.CONF.Base.InstallDir, "2panel/uploads/theme")
