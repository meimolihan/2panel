...
import (
	...
	"github.com/2Panel-dev/2Panel/core/app/api/v2/helper"
	...
	initauth "github.com/2Panel-dev/2Panel/core/init/auth"
	"github.com/2Panel-dev/2Panel/core/utils/captcha"
...
func (b *BaseApi) GetWelcomePage(c *gin.Context) {
	...
	file, err := os.ReadFile(path.Join(global.CONF.Base.InstallDir, "2panel/welcome/index.html"))
	if err != nil {
		helper.Success(c)
		return
	}
