...
import (
	...
	"github.com/2Panel-dev/2Panel/core/utils/csv"
...
func (u *CommandService) Export() (string, error) {
	...
	tmpFileName := path.Join(global.CONF.Base.InstallDir, "2panel/tmp/export/commands", fmt.Sprintf("1panel-commands-%s.csv", time.Now().Format(constant.DateTimeSlimLayout)))
