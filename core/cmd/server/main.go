...
import (
	...
	"github.com/2Panel-dev/2Panel/core/cmd/server/cmd"
	_ "github.com/2Panel-dev/2Panel/core/cmd/server/docs"
)
...
// @description Custom Token Format, Format: md5('2panel' + API-Key + UnixTimestamp).
// @description ```
// @description eg:
// @description curl -X GET "http://{host}:{port}/api/v2/toolbox/device/base" \
// @description -H "2Panel-Token: <2panel_token>" \
// @description -H "2Panel-Timestamp: <current_unix_timestamp>"
// @description ```
